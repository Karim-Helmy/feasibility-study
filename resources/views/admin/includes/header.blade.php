        ...
        <ul class="nav navbar-nav float-right">
          ...
          <li class="dropdown dropdown-notification nav-item">
           ...
           <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
             <li class="dropdown-menu-header">
               ...
               <span class="notification-tag badge badge-default badge-warning float-right m-0"> {{ $contactt->count() }} {{ trans('admin.new') }}</span>
             </li>
          ...
          <li class="dropdown dropdown-user nav-item">
            ...
            <div class="dropdown-menu dropdown-menu-right">
                <a class="dropdown-item" href="{{ aurl('/admins/edit') }}"><i class="la la-group"></i> {{ trans('admin.edit admins') }}</a>
