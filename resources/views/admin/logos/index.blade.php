      ...
      <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
        ...
        <div class="row breadcrumbs-top d-inline-block">
          <div class="breadcrumb-wrapper col-12">
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="{{ aurl("/logos/create") }}">{{ trans('admin.add logo') }}</a>
              </li>
            </ol>
          </div>
        </div>
                ...
                <div class="card-body card-dashboard">
                  <table class="table table-striped table-bordered dataex-html5-selectors">
                    ...
                    <tbody>
                        @foreach ($index as $i)
                            <tr id="show_{{ $i->id }}">
                                <td> <img src="{{ asset('uploads/'.$i->image) }}" title="{{ trans('admin.logo') }}" style="height:100px; width:200px;" /></td>
                                <td>{{ $i->link }}</td>
                                <td>
                                    <a href="{{ aurl('/logos/edit/'.$i->id) }}" class="btn btn-secondary btn-min-width mr-1 mb-1"><i
