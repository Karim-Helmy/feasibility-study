        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">{{ trans('admin.packages') }}</h4>
...
@section('scripts')
    <script>
        $(window).on("load", function(){
            ...
            // Chart Data
            var chartData = {
                labels: [@foreach ($packages as $name)"{{ $name->name }}",@endforeach],
                datasets: [{
                    label: "Packages subscriptions",
                    data:[@foreach ($packages as $package){{ $package->package_count }},@endforeach],
