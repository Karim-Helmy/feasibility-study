                    ...
                    <tbody>
                        @foreach ($index as $i)
                            <tr id="show_{{ $i->id }}">
                                ...
                                <td>
                                    <a href="{{ aurl('/scorms/show/'.$i->id) }}" target="_blank" class="btn btn-info btn-min-width mr-1 mb-1"><i
                                            class="far fa-eye"></i> {{ trans('admin.show') }}</a>
                                            &nbsp;&nbsp;&nbsp;
                                    <a href="{{ aurl('/scorms/edit/'.$i->id) }}" class="btn btn-secondary btn-min-width mr-1 mb-1"><i
