        ...
        <ul class="nav navbar-nav float-right">
          ...
          <li class="dropdown dropdown-language nav-item"><a class="dropdown-toggle nav-link" id="dropdown-flag" href="#" data-toggle="dropdown"
            ...
            <div class="dropdown-menu" aria-labelledby="dropdown-flag"><a class="dropdown-item" href="{{ url("setlocale/en") }}"><i class="flag-icon flag-icon-us"></i> English</a>
              <a class="dropdown-item" href="{{ url("setlocale/ar") }}"><i class="flag-icon flag-icon-sa"></i> العربية</a>
            </div>
          </li>
            ...
            <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
              <li class="dropdown-menu-header">
                <h6 class="dropdown-header m-0">
                  <span class="grey darken-2">الملاحظات</span>
                </h6>
                <span class="notification-tag badge badge-default badge-danger float-right m-0">2 جديدة</span>
              </li>
              <li class="scrollable-container media-list w-100">
                <a href="javascript:void(0)">
                  <div class="media">
                    ...
                    <div class="media-body">
                      <h6 class="media-heading">المنافسون</h6>
                      <p class="notification-text font-small-3 text-muted">رص مجموعة من الأحرف بشكل عشوائي أخذتها من نص</p>
                      <small>
                        <time class="media-meta text-muted" datetime="2015-06-11T18:29:20+08:00">من 30 دقيقة</time>
                      </small>
                    </div>
                  </div>
                </a>
                <a href="javascript:void(0)">
                  <div class="media">
                    ...
                    <div class="media-body">
                      <h6 class="media-heading red darken-1">الايرادات</h6>
                      <p class="notification-text font-small-3 text-muted">شكلي منذ القرن الخامس عشر  مجهولة برص مجموعة من</p>
                      <small>
                        <time class="media-meta text-muted" datetime="2015-06-11T18:29:20+08:00">من 5 ساعة</time>
                      </small>
                    </div>
                  </div>
                </a>
              ...
              <li class="dropdown-menu-footer"><a class="dropdown-item text-muted text-center" href="javascript:void(0)">عرض جميع الملاحظات</a></li>
            </ul>
          </li>
